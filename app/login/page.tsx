  ...
  return (
    <main className="grid min-h-screen place-items-center bg-mist px-4 text-ink">
      <section className="w-full max-w-md rounded-[32px] bg-paper p-6 shadow-soft">
        ...
        <p className="mt-2 text-sm text-neutral-500">Supabase Auth is used when environment variables are configured.</p>
        <div className="mt-6 space-y-3">
          <input className="tap w-full rounded-2xl border border-line bg-white px-4" placeholder="Email" value={email} onChange={(event) => setEmail(event.target.value)} />
